...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    accountType: Attribute.Enumeration<
      ['teacher', 'viceprincipal', 'headmaster', 'admin']
    >;
...
export interface ApiAbsencyAbsency extends Schema.CollectionType {
...
export interface ApiAccountTypeAccountType extends Schema.CollectionType {
...
export interface ApiMataPelajaranMataPelajaran extends Schema.CollectionType {
  collectionName: 'mata_pelajarans';
  info: {
    singularName: 'mata-pelajaran';
    pluralName: 'mata-pelajarans';
    displayName: 'Subject';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    teachings: Attribute.Relation<
      'api::mata-pelajaran.mata-pelajaran',
      'oneToMany',
      'api::teaching.teaching'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiPresencePresence extends Schema.CollectionType {
...
export interface ApiScheduleSchedule extends Schema.CollectionType {
  ...
  attributes: {
    ...
    teaching: Attribute.Relation<
      ...
      'api::teaching.teaching'
    >;
    jadwal: Attribute.String;
    hari: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::absency.absency': ApiAbsencyAbsency;
